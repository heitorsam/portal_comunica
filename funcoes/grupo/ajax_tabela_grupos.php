<?php
    ...
    $cons_buscar_grupos = "SELECT CD_GRUPO,                           
                           DS_GRUPO,                           
                           (SELECT COUNT(CD_CHAMADO) FROM portal_comunica.CHAMADO WHERE CD_GRUPO = grp.CD_GRUPO) AS QTD_CHAMADOS,
                           (SELECT COUNT(CD_GRUPO_USUARIO) FROM portal_comunica.GRUPO_USUARIO WHERE CD_GRUPO = grp.CD_GRUPO) AS QTD_GRUPO_USUARIO
        ...
        <?php
            ...
            while ($row = mysqli_fetch_array($res)) {
                ...
                echo '<tr style="text-align: center">';
                    ...
                    echo '<td class="align-middle">'. $row['QTD_GRUPO_USUARIO'] .'</td>';
                    ...
                    echo '<td class="align-middle">
                        ...
                        if($row['QTD_GRUPO_USUARIO'] == 0 && $row['QTD_CHAMADOS'] == 0){
        ?>
